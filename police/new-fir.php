...
<a href="view-fir-details.php?editid=<?php echo htmlentities($row->ID);?>" class="btn btn-primary btn-sm">View</a>

<a href="take_action.php?firid=<?php echo htmlentities($row->ID);?>" class="btn btn-success btn-sm">Take Action</a>
</td>
                                    </tr>
                                    <?php $cnt=$cnt+1;}} else { ?> 
                                <tr>
