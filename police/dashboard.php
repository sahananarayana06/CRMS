									...
									<section class="panel panel-featured-left panel-featured-tertiary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Total Accepted Complaints</h4>
														<div class="info">
															<?php 
$sql2 ="SELECT ID from tblcomplaint where Status='Approved' and PoliceStationId=:psid";
$query2 = $dbh -> prepare($sql2);
$query2->bindParam(':psid',$psid,PDO::PARAM_STR);
$query2->execute();
$totalacceptedcomplaints=$query2->rowCount();
?>
															<strong class="amount"><?php echo htmlentities($totalacceptedcomplaints);?></strong>
														</div>
													</div>
													<div class="summary-footer">
														<a href="accepted-complaints.php">(view all)</a>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="col-md-6 col-lg-3">							<section class="panel panel-featured-left panel-featured-danger">
								<div class="panel-body">
									<div class="widget-summary">
										<div class="widget-summary-col widget-summary-col-icon">
										...
										<div class="widget-summary-col">
											<div class="summary">
												<h4 class="title">Total Rejected Complaints</h4>
												<div class="info">
													<?php 
$sql3 ="SELECT ID from tblcomplaint where Status='Rejected' and PoliceStationId=:psid";
$query3 = $dbh -> prepare($sql3);
$query3->bindParam(':psid',$psid,PDO::PARAM_STR);
$query3->execute();
$totalrejectedcomplaints=$query3->rowCount();
?>
													<strong class="amount"><?php echo htmlentities($totalrejectedcomplaints);?></strong>
												</div>
											</div>
											<div class="summary-footer">
												<a href="rejected-complaints.php">(view all)</a>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="col-md-6 col-lg-3">									<section class="panel panel-featured-left panel-featured-quartenary">
										<div class="panel-body">
											<div class="widget-summary">
												<div class="widget-summary-col widget-summary-col-icon">
