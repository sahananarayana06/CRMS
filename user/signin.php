    ...
    if($query->rowCount() > 0)
{
        if($result->is_verified == 1) {
            ...
            echo "<script>alert('Your account is not verified yet. Please enter the OTP sent to your email.'); window.location.href='verify.php?email=".urlencode($email)."';</script>";
        }
} else{
